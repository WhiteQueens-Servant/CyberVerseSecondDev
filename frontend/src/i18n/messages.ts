export const baseMessages = {
  'zh-CN': {
    ...
    characterEdit: {
      ...
      scenicConfig: '景区配置',
      scenicCategory: '数字人类别',
      scenicCategoryPlaceholder: '选择类别',
      scenicCategoryGuide: '导游',
      scenicCategoryNarrator: '讲解员',
      scenicCategoryService: '客服',
      scenicCategoryHint: '配置该角色在景区场景中的类别',
      scenicSystemPrompt: '景区人设提示词（可选）',
      scenicSystemPromptPlaceholder: '如：你是XX景区的专属导游，热情向游客推荐景点，熟悉每条游览路线...',
      scenicSystemPromptHint: '填写后将覆盖原角色提示词，用于景区场景专属人设。留空则使用原角色提示词。',
      recommendedRoutes: '推荐路线',
      recommendedRoutesHint: '勾选该角色可推荐的游览路线',
      noRoutes: '暂无路线，请先在路线管理中创建',
      knowledgeBase: '素材库',
    ...
    scenic: {
      title: '泉城智游',
      subtitle: '千年泉韵 · 数字新生',
      description: '选择一位数字人导游，开启实时语音对话。询问景点介绍、推荐路线、门票信息，或让导游为您定制专属游览方案。',
      startChat: '开启对话',
      connecting: '正在连接...',
      guideLabel: 'AI 导游',
      attractionsTitle: '名胜古迹',
      routesTitle: '游赏路线',
      noAttractions: '暂无景点信息',
      noRoutes: '暂无推荐路线',
      noGuide: '暂无可用的导游角色，请联系管理员配置',
      categoryGuide: '导游',
      categoryNarrator: '讲解员',
      categoryService: '客服',
      duration: '时长',
      difficulty: '难度',
      stops: '途经',
      errorConnect: '连接失败，请检查服务状态',
      detail: {
        loadError: '加载景点信息失败',
        startChatAbout: '询问导游关于此景点',
        openingHours: '开放时间',
        ticketInfo: '门票信息',
      },
      routeDetail: {
        loadError: '加载路线信息失败',
        routeSteps: '路线途经',
        unknownAttraction: '未知景点',
        minutes: '分钟',
        viewAttraction: '查看景点详情',
      },
    },
  },
  'en-US': {
    ...
    characterEdit: {
      ...
      scenicConfig: 'Scenic Configuration',
      scenicCategory: 'Digital Human Type',
      scenicCategoryPlaceholder: 'Select type',
      scenicCategoryGuide: 'Tour Guide',
      scenicCategoryNarrator: 'Narrator',
      scenicCategoryService: 'Customer Service',
      scenicCategoryHint: 'Configure the character type for the scenic scenario',
      scenicSystemPrompt: 'Scenic Persona Prompt (optional)',
      scenicSystemPromptPlaceholder: 'e.g. You are the dedicated tour guide of XX Scenic Area, enthusiastically recommending attractions and familiar with every route...',
      scenicSystemPromptHint: 'If filled, overrides the base role prompt for the scenic persona. Leave empty to use the original role prompt.',
      recommendedRoutes: 'Recommended Routes',
      recommendedRoutesHint: 'Select the tour routes this character can recommend',
      noRoutes: 'No routes yet. Create routes in Route Management first.',
    ...
    nav: {
      adminPortal: 'Operations Center',
      backToScenic: 'Back to Scenic',
    ...
    scenic: {
      title: 'Spring City Smart Tour',
      subtitle: 'Ancient Spring Charm · Digital Rebirth',
      description: 'Choose a digital human guide for real-time voice conversation. Ask about attractions, recommended routes, ticket info, or let the guide customize your tour plan.',
      startChat: 'Start Chat',
      connecting: 'Connecting...',
      guideLabel: 'AI Guide',
      attractionsTitle: 'Historic Sites',
      routesTitle: 'Tour Routes',
      noAttractions: 'No attraction information yet',
      noRoutes: 'No recommended routes yet',
      noGuide: 'No guide available. Please contact the administrator.',
      categoryGuide: 'Guide',
      categoryNarrator: 'Narrator',
      categoryService: 'Service',
      duration: 'Duration',
      difficulty: 'Difficulty',
      stops: 'Stops',
      errorConnect: 'Connection failed. Please check the service status.',
      detail: {
        loadError: 'Failed to load attraction info',
        startChatAbout: 'Ask the guide about this spot',
        openingHours: 'Opening Hours',
        ticketInfo: 'Ticket Info',
      },
      routeDetail: {
        loadError: 'Failed to load route info',
        routeSteps: 'Route Stops',
        unknownAttraction: 'Unknown attraction',
        minutes: 'min',
        viewAttraction: 'View attraction details',
      },
    },
  },
} as const
