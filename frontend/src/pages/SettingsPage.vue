      ...
      <div class="flex flex-col gap-6">
        ...
        <div class="flex items-center justify-end gap-3 pb-4">
          ...
          <button @click="save" :disabled="saving"
                  class="px-6 py-2.5 bg-cv-accent text-white text-sm font-medium rounded-cv-md hover:bg-cv-accent-hover transition-colors cursor-pointer disabled:opacity-40 shadow-[0_2px_8px_rgba(107,175,141,0.3)]">
