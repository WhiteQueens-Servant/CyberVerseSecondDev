...
# Markdown regex patterns for stripping formatting before display/TTS.
...
def strip_markdown(text: str) -> str:
    """Remove common Markdown formatting so TTS does not read symbols aloud."""
        ...
        async def emit_turn_final(reason: str) -> bool:
            ...
            await output_queue.put(
                VoiceLLMOutputEvent(
                    ...
                    transcript=strip_markdown(turn_transcript),
                    is_final=True,
            ...
            async for message in ws:
                ...
                if decoded.is_audio():
                    ...
                    if assistant_text and decoded.event == DoubaoEvent.LLM_TOKEN:
                        ...
                        await output_queue.put(
                            VoiceLLMOutputEvent(
                                transcript=strip_markdown(assistant_text),
                                question_id=turn_question_id,
                                reply_id=turn_reply_id,
                            )
                        )
